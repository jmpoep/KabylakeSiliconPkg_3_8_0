...
Name (DPLD, Package (0x1) {
           ToPLD (
             ...
             PLD_Panel = "TOP", // Describes which panel surface of the system’s housing the device connection point resides on.
             ...
             PLD_GroupPosition = 0x0, // Identifies this device connection point’s position in the group (i.e. 1st, 2nd)
