...
**/
  ...
  Offset(277),    DIDY, 32, // Offset(277),   Device ID for second LFP device
  Offset(281),    NXDY, 32, // Offset(281),   Next state DID for Second Display
  Offset (500),             // Offset(285) : Offset(499), Reserved bytes
