@REM @file
@REM  Batch file for Memory Reference Code (MRC) mini-BIOS build execution.
@REM
@REM @copyright
@REM  INTEL CONFIDENTIAL
@REM  Copyright 2013 - 2016 Intel Corporation.
@REM
...
nmake -f MiniBios.mak clean all %1 %2 %3 %4 %5 %6 %7 %8 %9
