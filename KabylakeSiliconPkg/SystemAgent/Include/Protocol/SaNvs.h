...
typedef struct {
  ...
  UINT32   DeviceIdY;                               ///< Offset 277     Device ID for second LFP device
  UINT32   NextStateDidEdp2;                        ///< Offset 281     Next state DID for Second Display
  UINT8    Reserved0[215];                          ///< Offset 285:499
